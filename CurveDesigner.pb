...
;               Version 1.2  Jun 28, 2023 (DrShrek aka IceSoft)
...
Global title.s = "Vector Curve Designer Version 1.2"
...
; Images
Global.i imgCursor=CreateCursor(),imgOriginalBackground,imgOutput,imgZoomed,imgZoomNormal,imgZoomViewport,imgUndo,imgRedo,imgClear,imgLupe, imgMagnifier
...
Global.i gadget_zoom,gadget_zoom_viewport, gadget_Magnifier
...
OpenWindow(0,0,0,1024,710,title,#PB_Window_ScreenCentered |
...
FrameGadget(#PB_Any, 10,180,270,50,"View")
option3=OptionGadget(#PB_Any,40,200,70,20,"Design")
option4=OptionGadget(#PB_Any,120,200,70,20,"Code")
option5=OptionGadget(#PB_Any,200,200,70,20,"Test")
...
FrameGadget(#PB_Any, 10,250,270,50,"Curve Type")
option6=OptionGadget(#PB_Any,40,270,90,20,"Independent")
option7=OptionGadget(#PB_Any,160,270,90,20,"Continuation")
...
; 
gadget_Magnifier = ImageGadget(#PB_Any,40,480,0,0,0,#PB_Image_Raised)
imgMagnifier=CreateImage(#PB_Any, 200,200)
SetGadgetState(gadget_Magnifier, ImageID(imgMagnifier))
HideGadget(gadget_Magnifier, 0)
...
Procedure RedrawCurves()
  ...
  Box(0,0,ImageWidth(imgLayers(zoomlevel)),ImageHeight(imgLayers(zoomlevel)),RGBA(0,250,0,0))
  StopDrawing()
  ...
  If curveactive
    ...
    VectorSourceColor(RGBA(255,0,0,255))
    DashPath(1,2)
    AddPathCircle(startpoint\x,startpoint\y,sizeCirle)
    VectorSourceColor(RGBA(250,0,0,255))
    FillPath()
    AddPathCircle(firstpoint\x,firstpoint\y,sizeCirle)
    VectorSourceColor(RGBA(248,0,0,255))
    FillPath()         
    AddPathCircle(secondpoint\x,secondpoint\y,sizeCirle)
    VectorSourceColor(RGBA(246,0,0,255))
    FillPath()         
    AddPathCircle(endpoint\x,endpoint\y,sizeCirle)
